...
<!--     <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">PJTKI KOTA DEPOK</td>
            <td class="subject" width="300"><a class="strong" href="http://pjtki.aozoratech.com/" target="_blank">http://pjtki.aozoratech.com/</a></td>
        </tr>
        <tr>
    ...
    <table class="main center" width="602" border="0" cellspacing="0" cellpadding="0" style="    border-left: 1px solid #e8e7e5;
            ...
            <td class="column">
                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            <td class="padded">
                                <img src="cid:cv" style="width: 100%;display: block;position: relative;margin: 0px auto;">
                                <h1>Pengiriman CV Berhasil</h1>
                                <p>Selamat, <strong><?php echo $subject;?></strong>.</p>
                                <p>Mohon tunggu informasi lebih lanjut dari perusahaan tersebut</p>
                            </td>
                        </tr>
                    </tbody>
                </table>

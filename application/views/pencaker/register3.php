...
// pikadayResponsive(document.getElementById("tglmasuk1"));
// pikadayResponsive(document.getElementById("tglkeluar1"));
// $("#tgllahir").datepicker({
//         constrainInput: true,
//         changeMonth: true,
//         changeYear: true,
...
//     pikadayResponsive(document.getElementById("tglkeluar"+nomer+""));
...
function tambah_member()
    {
      ...
      if(nomer<6){
            ...
            tampung += '&nbsp;&nbsp;&nbsp;Jabatan&nbsp;&nbsp;<input id="jabatan'+nomer+'" name="jabatan'+nomer+'" type="text" value="" size="14">';
            // tampung += '&nbsp;&nbsp;Uraian&nbsp;&nbsp;<input id="uraian'+nomer+'" name="uraian'+nomer+'" type="text" value="" size="20">';
            tampung += '&nbsp;&nbsp;perusahaan&nbsp;<input id="perusahaan'+nomer+'" name="perusahaan'+nomer+'" type="text" value="" size="14">';
            tampung += '&nbsp;&nbsp;&nbsp;Tanggal Masuk&nbsp;<input id="tglmasuk'+nomer+'" name="tglmasuk'+nomer+'" type="text" value="<?= $input != null ? $input['tglmasuk1'] : date('d-m-Y', mktime(0, 0, 0, 1, 1, 1990)) ?>" size="10" maxlength="10">';
            tampung += '&nbsp;&nbsp;&nbsp;Tanggal Keluar&nbsp;<input id="tglkeluar'+nomer+'" name="tglkeluar'+nomer+'" type="text" value="<?= $input != null ? $input['tglmasuk1'] : date('d-m-Y', mktime(0, 0, 0, 1, 1, 1990)) ?>" size="10" maxlength="10"></div>';

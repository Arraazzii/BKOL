                ...
                <tbody>
                    <tr>
                        <td align="center">
                            ...
                            <div align="center">
                                <form method="post" action="<?= site_url('perusahaan/updatelowongan/'.$IDLowongan)?>">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="top">
                                                    ...
                                                    <a class="confirmLink button" href="<?= site_url('perusahaan/deletelowongan/'.$IDLowongan) ?>">Hapus</a>
                                                    <a class="button" href="<?= site_url('perusahaan/lowongan') ?>">Batal</a>

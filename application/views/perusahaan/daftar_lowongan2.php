                        ...
                        <table width="100%" class="table-form">
                                <tbody>
                                        ...
                                        <tr>
                                                <td align="center">
                                                        <div align="left">
                                                                <form method="post" action="<?= site_url('perusahaan/carilowongan') ?>">
                                                                        <table>
                                                                                <tr>
                                                                                        <td align="left">
                                                                                                PERIODE
                                                        ...
                                                        <div align="left">
                                                                <a href="<?= site_url('perusahaan/lowongan/tambahdata') ?>" class="button">Tambah Lowongan</a>
                                                        </div>
                                                </td>
                                        </tr>
                                        <tr>
...
if ($MsLowonganData->num_rows > 0)
{
        foreach ($MsLowonganData->result() as $getdata)
        {
                $this->table->add_row(
                        ...
                        array('data'=>'<a href="'.site_url('perusahaan/lowongan/detail/'.$getdata->IDLowongan).'" class="button">Detail</a>', 'style'=>'text-align:center;')
                );
        }
}
else

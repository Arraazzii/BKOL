...
<section class="content">
    <form method="POST" class="form-horizontal" role="form" action="<?= site_url('perusahaan/lowongan/detail/'.$this->uri->segment(4))?>">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Detail Data Lowongan Kerja</h3>
            </div>
            <div class="box-body">

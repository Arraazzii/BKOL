            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php foreach ($MsPencakerData as $getdata): ?>
                        ...
                        $cetakak = '<a class="btn btn-default btn-sm" onclick="cetak_ak(\''.$getdata->IDPencaker.'\') "><i class="fa fa-print"></i> Cetak AK1</a>';
                        $detailbtn = '<a class="btn btn-default btn-sm" onclick="DoView(\''.$getdata->IDPencaker.'\') "><i class="fa fa-eye"></i> Detail</a>';
                        $deletebtn = '<a class="btn btn-default btn-sm" onclick="DoDelete(\''.$getdata->IDPencaker.'\')"><i class="fa fa-trash"></i> Hapus</a>';

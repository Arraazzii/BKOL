...
<head>
    ...
    <style type="text/css" media="print">
		...
		/* right side */
		.nip_pencaker { margin-left: 23.3cm; margin-top: 3.0cm; position: fixed; font-size: 16px }
		.nomor_penduduk { margin-left: 23.3cm; margin-top: 3.7cm; position: fixed; position: fixed; font-size: 16px; }

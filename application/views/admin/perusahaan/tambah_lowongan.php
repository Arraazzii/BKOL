...
<?php
        ...
        if ($input != NULL)
        {
                $MsKeahlianData = $input['MsKeahlianData'];
        }
?>
<table width="100%">
        <tr>
                                ...
                                <tbody>
                                        <tr>
                                                <td align="center">
                                                        ...
                                                        <div align="center">
                                                                <form method="post" action="<?= site_url('admin/perusahaan/'.$IDPerusahaan.'/addlowongan')?>">
                                                                        <table class="table-form" width="100%">
                                                                                <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <input id="jmlpria" name="jmlpria" type="text" value="<?= $input != null ? $input['jmlpria'] : '0' ?>" size="20">
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <input id="jmlwanita" name="jmlwanita" type="text" value="<?= $input != null ? $input['jmlwanita'] : '0' ?>" size="20">
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <input id="batasumur" name="batasumur" type="text" value="<?= $input != null ? $input['batasumur'] : '0' ?>" size="20">
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <textarea id="pengalaman" name="pengalaman" cols="30" rows="3" maxlength="300"><?= $input != null ? $input['pengalaman'] : '' ?></textarea>
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <textarea id="syaratkhusus" name="syaratkhusus" cols="30" rows="3" maxlength="300"><?= $input != null ? $input['syaratkhusus'] : '' ?></textarea>
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <th align="center" colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <input id="gajiperbulan" name="gajiperbulan" type="text" value="<?= $input != null ? $input['gajiperbulan'] : '0' ?>" size="20">
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <input id="jamkerjaseminggu" name="jamkerjaseminggu" type="text" value="<?= $input != null ? $input['jamkerjaseminggu'] : '0' ?>" size="20">
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        ...
                                                                                                        <a href="<?= site_url('admin/perusahaan/'.$IDPerusahaan.'/lowongan') ?>" class="button">Batal</a>
                                                                                                </td>
                                                                                        </tr>
                                                                                </tbody>
                                                                        </table>

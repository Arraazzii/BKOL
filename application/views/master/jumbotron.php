	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="<?php echo site_url('assets/css/images/hd-1.jpg'); ?>" alt="" class="img-responsive stretch">
			</div>

			<div class="item">
				<img src="<?php echo site_url('assets/css/images/banner.png'); ?>" alt="" class="img-responsive stretch">
			</div>

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="SendLowongan()"><i class="fa fa-send"></i> Kirim Lowongan</button>
...
<div class="row">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Loker Bekasi</a></li>
      <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Loker Luar Bekasi</a></li>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab_3">
        ...
        if ($CountMsEventData > 0)
        {
          ...
          echo '</ul>';
          echo '<div align="text-center"><a class="btn btn-primary" href="'.site_url('event').'">Selengkapnya</a></div>';
        }
        else
        {
          echo '<div align="center">belum ada data</div>';

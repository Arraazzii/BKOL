                                ...
                                <tbody>
                                        ...
                                        <tr>
                                                <td align="left" colspan="2">
                                                        <a class="button" href="<?= site_url('pencaker/edit') ?>">Detail Profil</a>
                                                        <a class="button" href="<?= site_url('pencaker/editcv') ?>">Detail CV</a>
                                                </td>
                                        </tr>
                                        <tr>
                                                <th align="center" colspan="3">
                                        ...
                                        <tr>
                                                <td align="left" colspan="3">
                                                        <a class="button" href="<?= site_url('pencaker/editbahasa') ?>">Detail Bahasa</a>
                                                </td>
                                        </tr>
                                        <tr>
                                                <th align="center" colspan="3">
                                        ...
                                        <tr>
                                                <td align="left" colspan="3">
                                                        <a class="button" href="<?= site_url('pencaker/editpengalaman') ?>">Detail Pengalaman</a>
                                                </td>
                                        </tr>
                                </tbody>
                        </table>

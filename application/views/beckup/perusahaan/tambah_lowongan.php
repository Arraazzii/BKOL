                                ...
                                <tbody>
                                        <tr>
                                                <td align="center">
                                                        ...
                                                        <div align="center">
                                                                <form method="post" action="<?= site_url('perusahaan/addlowongan')?>">
                                                                        <table class="table-form" width="100%">
                                                                                <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <textarea id="pengalaman" name="pengalaman" cols="30" rows="3" maxlength="500"><?= $input != null ? $input['pengalaman'] : '' ?></textarea>
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <td align="left" valign="top">
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        <textarea id="syaratkhusus" name="syaratkhusus" cols="30" rows="3" maxlength="500"><?= $input != null ? $input['syaratkhusus'] : '' ?></textarea>
                                                                                                </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                <th align="center" colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td align="left" valign="top">
                                                                                                        ...
                                                                                                        <a href="<?= site_url('perusahaan/lowongan') ?>" class="button">Batal</a>
                                                                                                </td>
                                                                                        </tr>
                                                                                </tbody>
                                                                        </table>

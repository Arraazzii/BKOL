...
if ($MsPencakerData->num_rows > 0)
{
        ...
        foreach ($MsPencakerData->result() as $getdata)
        {
                ...
                $this->table->add_row(
                        ...
                        array('data'=>($getdata->StatusLowongan ? 'Diterima' : 'Belum diterima'), 'style'=>'text-align:center;'),
...
function DoEdit(IDLowonganMasuk)
{
        ...
        function(getdata)
        {
                if (getdata.exists)
                {
                        ...
                        $('#statuslowongan').html(getdata.StatusLowongan ? 'Diterima' : 'Belum Diterima');

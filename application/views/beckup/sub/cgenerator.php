...
<?php
        ...
        else if ($idjenisuser == "000001")
        {
                ...
                {
                        $this->load->view('perusahaan/profil_edit');
                }
                ...
                {
                        $this->load->view('perusahaan/profil_pemberikerja_edit');
                }
                else if ($route == "pencaker")
                {
                ...
                {
                        $this->load->view('perusahaan/tambah_lowongan');
                }
        ...
        else if ($idjenisuser == "000002")
        {
                ...
                else if ($aktif)
                {
                        ...
                        {
                                $this->load->view('pencaker/profil_edit');
                        }
        ...
        else
        {
                ...
                else if ($route == "register")
                {
                        ...
                        {
                                $this->load->view('perusahaan/register');
                        }
                        else if ($mode == "2")
                        {
                                $this->load->view('pencaker/register');
                        }
                }
                else if ($route == "login")
                {

...
class MsPerusahaanTemp extends CI_Model
{
    ...
    public function get_datatable_perusahaan()
    {
        ...
        $button = '<a class="btn btn-success btn-sm" onclick="DoActivateConfirm(\''.'$1'.'\')"><i class="fa fa-check"></i> Terima </a> <a class="btn btn-danger btn-sm" onclick="DoDeleteConfirm(\''.'$1'.'\')"><i class="fa fa-trash"></i> Hapus </a>';

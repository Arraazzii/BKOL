...
class MsPencaker extends CI_Model
{
        ...
        public function get_datatable_pencaker()
        {
            ...
            $this->datatables->add_column('view', '<a class="btn btn-default btn-sm" onclick="cetak_ak(\''.'$1'.'\') "><i class="fa fa-print"></i> Cetak AK1</a><a class="btn btn-default btn-sm" onclick="DoView(\''.'$1'.'\') "><i class="fa fa-eye"></i> Detail</a><a class="btn btn-default btn-sm" onclick="DoDelete(\''.'$1'.'\')"><i class="fa fa-trash"></i> Hapus</a>','IDPencaker');

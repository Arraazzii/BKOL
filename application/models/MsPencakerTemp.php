...
class MsPencakerTemp extends CI_Model
{
        ...
        public function get_datatable_pencaker()
        {
            ...
            $button = '<a class="btn btn-default btn-sm" onclick="DoView(\''.'$1'.'\') "><i class="fa fa-eye"></i> Detail </a><a class="btn btn-default btn-sm" onclick="DoActivateConfirm(\''.'$1'.'\')"><i class="fa fa-check"></i> Terima </a><a class="btn btn-default btn-sm" onclick="DoDeleteConfirm(\''.'$1'.'\')"><i class="fa fa-trash"></i> Hapus </a>';

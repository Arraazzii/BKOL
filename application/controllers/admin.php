            ...
            if ($this->input->post()) 
            {
                ...
                if($jenis == 0)
                {
                    ...
                    if($cat == 0)
                    {
                        ...
                        foreach($data['detail'] as $key => $val)
                        {
                            ...
                            $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $val['kecamatan']);
                            $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $val['pria']);
                            $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $val['wanita']);
                    ...
                    elseif($cat == 1)
                    {
                        ...
                        {
                            $excel->setActiveSheetIndex(0)->setCellValue('A'.$numrow, $no);      
                            $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $val['Kelompok Umur']);
                            $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $val['pria']);
                            $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $val['wanita']);
                            $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $val['total']);
                            $excel->getActiveSheet()->getStyle('A'.$numrow)->applyFromArray($style_row);
                    ...
                    elseif($cat == 2)
                    {
                        ...
                        {
                            $excel->setActiveSheetIndex(0)->setCellValue('A'.$numrow, $no);      
                            $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $val['pendidikan']);
                            $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $val['pria']);
                            $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $val['wanita']);
                            $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $val['total']);
                            $excel->getActiveSheet()->getStyle('A'.$numrow)->applyFromArray($style_row);
                    ...
                    $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $data['summary'][0]->pria);
                    $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $data['summary'][0]->wanita);
                ...
                elseif($jenis == 1)
                {
                    ...
                    foreach($data['detail'] as $key => $val)
                    {
                        ...
                        $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $val['Status']);
                ...
                elseif($jenis == 2)
                {
                    ...
                    foreach($data['detail'] as $key => $val)
                    {
                        ...
                        $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $val['NamaLowongan']);
                        $excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $val['NamaStatusPendidikan']);
                        $excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $val['JenisKelamin']);
                        $excel->getActiveSheet()->getStyle('A'.$numrow)->applyFromArray($style_num);
                        $excel->getActiveSheet()->getStyle('B'.$numrow)->applyFromArray($style_row);
                        $excel->getActiveSheet()->getStyle('C'.$numrow)->applyFromArray($style_row);
                        $excel->getActiveSheet()->getStyle('D'.$numrow)->applyFromArray($style_row);
